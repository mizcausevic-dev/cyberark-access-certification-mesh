...
const checks = [
  ...
  ["Title matches", html.includes("CyberArk Access Certification Mesh")],
  ...
  ["CNAME = cert.kineticgain.com", readFileSync(new URL("CNAME", root), "utf8").trim() === "cert.kineticgain.com"],
